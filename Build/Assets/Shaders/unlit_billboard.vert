...
void main()
{
	...
	//set vertex position using (local) world position and view direction 
	position = position + (vposition.x * right * size.x) + (vposition.y * up * size.y); // orient quad to face view
