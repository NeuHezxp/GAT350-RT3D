...
namespace nc
{
    bool World04::Initialize()
    {
        ...
        m_model->Load("models/chickito.obj"); // The boject for the model // Go to grid.mtrl for texture
    ...
    void World04::Update(float dt)
    {
        ...
        // projectioon matrix
        glm::mat4 projection = glm::perspective(glm::radians(70.0f), 800.0f / 600.0f, 0.01f, 100.0f); //znear is clipping for how close // zFar is anything far away is gone
